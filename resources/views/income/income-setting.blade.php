            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between my-4">
                        ...
                        {{-- RIGHT : Action Button --}}
                        <div>
                            <a href="{{ route('income-create-category-view') }}" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium
                            ...
                            <a href="{{ route('income-create-sub-category-view') }}" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium
                                    text-white bg-blue-600 rounded-lg
                                    hover:bg-blue-700 transition
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2
                                    dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-offset-gray-800">
                                        ...
                                        <tr class="transition-colors duration-150
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <div class="flex items-center justify-center gap-3">
                                                    ...
                                                    {{-- View --}}
                                                    <a href="{{ route('income-excategories.update.view', $val->id) }}"
                                                    ...
                                                    <form action="{{ route('income-expenses.category.delete', $val->id) }}"
                                                        method="POST"
                                        ...
                                        <tr class="transition-colors duration-150
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <div class="flex items-center justify-center gap-3">
                                                    ...
                                                    {{-- View --}}
                                                    <a href="{{ route('income-subcategories.update', $val->id) }}"
                                                    class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    ...
                                                    <form action="{{ route('income-exsubcategories.delete', $val->id) }}"
                                                        method="POST"
