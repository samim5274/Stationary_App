                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white border border-gray-100 rounded-xl shadow-sm
                            ...
                            <p class="text-xl font-bold text-gray-800 dark:text-gray-100">{{ number_format($categories->total()) }}</p>
                            </div>
                        </div>
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2">
                                ...
                                <table class="w-full whitespace-nowrap">
                                    ...
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        @forelse($categories as $c)
                                            <tr class="group text-gray-700 dark:text-gray-300 hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-gray-700/40 dark:hover:text-gray-100  transition">
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10 rounded-full flex items-center justify-center
                                                                    ...
                                                                    dark:bg-purple-700 dark:text-purple-900">
                                                            {{ strtoupper(substr($c->name ?? 'C', 0, 1)) }}
                                                        </div>

                                                        <div>
                                                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">
                                                                {{ $c->name }}
                                                            </p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                                                ID: <span class="font-semibold">{{ $c->id }}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                        ...
                        <div class="w-full overflow-hidden rounded-xl bg-white shadow-sm
                            ...
                            {{-- Form --}}
                            <form action="{{ route('category.create') }}" method="POST" class="px-6 py-6 space-y-6">
                                @csrf
