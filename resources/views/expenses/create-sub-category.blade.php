                        ...
                        <div class="lg:col-span-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div
                                            class="h-11 w-11 flex items-center justify-center
                                                ...
                                                shrink-0">
                                            <i class="fa-solid {{ isset($exsubcategory) ? 'fa-pen-to-square' : 'fa-sitemap' }}
                                                    text-blue-600 dark:text-blue-400 text-lg"></i>
                                        </div>

                                        <div class="leading-tight">
                                            <h2 class="text-lg font-extrabold text-gray-800 dark:text-gray-100">
                                                {{ isset($exsubcategory) ? 'Edit Expense Subcategory' : 'Create Expense Subcategory' }}
                                            </h2>
                                    ...
                                    {{-- Right: Status Badge --}}
                                    @php($isEdit = isset($exsubcategory))
                            ...
                            {{-- Form --}}
                            <form
                                action="{{ isset($exsubcategory) ? route('exsubcategories.modify', $exsubcategory->id) : route('exsubcategories.store') }}"
                                method="POST"
                                class="p-6 space-y-6" >
                                
                                @csrf
                                @if(isset($exsubcategory))
                                    @method('PUT')
                                @endif
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select
                                            ...
                                            required >
                                            <option value="" disabled {{ old('category_id', $exsubcategory->category_id ?? '') ? '' : 'selected' }}>
                                                -- Select Category --
                                            </option>

                                            @foreach($categories as $cat)
                                                <option value="{{ $cat->id }}"
                                                    @selected(old('category_id', $exsubcategory->category_id ?? '') == $cat->id)>
                                                    {{ $cat->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            type="text"
                                            name="name"
                                            value="{{ old('name', $exsubcategory->name ?? '') }}"
                                ...
                                <div class="pt-2 flex flex-wrap items-center justify-end gap-2">
                                    ...
                                    <button type="submit"
                                        ...
                                        <i class="fa-solid {{ isset($exsubcategory) ? 'fa-pen-to-square' : 'fa-plus' }} mr-2"></i>
                                        {{ isset($exsubcategory) ? 'Update Subcategory' : 'Create Subcategory' }}
                                    </button>
                                </div>
