...
<div class="wrap">
    ...
    <h3>Daily Sale / Payment Report Between ({{ $start->format('d M Y') }} - {{ $end->format('d M Y') }})</h3>
    <h3>User: {{ isset($selectedUser) ? $selectedUser->first_name .' '.$selectedUser->last_name : 'All Users' }}</h3>
    <hr>
