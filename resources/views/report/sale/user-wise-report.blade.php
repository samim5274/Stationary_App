        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <form action="{{ route('filter-user-wise-sale-report') }}" method="GET">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow border dark:border-gray-700 overflow-hidden">
                        ...
                        <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                            <table class="min-w-full text-sm">
                                ...
                                <tfoot>
                                    <tr class="text-left text-gray-700 dark:text-gray-200">
                                        <th colspan="5" class="px-5 py-3 font-semibold whitespace-nowrap">Total</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('total') }}/-</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('discount') }}/-</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('vat') }}/-</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('payable') }}/-</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('pay') }}/-</th>
                                        <th class="px-5 py-3 font-semibold whitespace-nowrap text-right">৳ {{ $paymentDetails->sum('due') }}/-</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
